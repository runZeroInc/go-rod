...
- Pretty output using [gop](https://github.com/runZeroInc/go-rod/pkg/internal/gop) and [diff](lib/diff)
...
go run github.com/runZeroInc/go-rod/pkg/internal/got/cmd/check-cov@latest
```
...
[Link](https://pkg.go.dev/github.com/runZeroInc/go-rod/pkg/internal/got)
