...
func description(dev bool) string {
	...
	return `--label=org.opencontainers.image.description=https://github.com/runZeroInc/go-rod/blob/` + headSha + "/lib/docker/" + f
}

const registry = "ghcr.io/runZeroInc/go-rod"
